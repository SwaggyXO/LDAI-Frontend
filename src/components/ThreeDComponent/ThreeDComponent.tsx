...
import { HeartModel as Model } from "../../Models/HeartModel";
    ...
    function Annotations({ controls } : any) {
        ...
        useEffect(() => {
            const handleClick = (event: MouseEvent) => {
                if (event.target && event.target instanceof Element) {
                    if (!event.target.closest('.annotation-wrapper') && hasClickedAnnotation) {
                        setSelected(-1);
        ...
        return (
            <>
                {annotations.map((a, i) => {
                    return (
                        <Html className="annotation-wrapper" key={i} position={[a.lookAt.x, a.lookAt.y, a.lookAt.z]}>
                            <svg
                                height="34"
                                width="34"
    ...
    const content = (
        ...
        >
            ...
            <Suspense fallback={<Loader />}>
                ...
                <OrbitControls ref={ref} minPolarAngle={0} maxPolarAngle={Math.PI / 2} />
